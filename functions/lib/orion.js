                ...
                try {
                    switch (block.name) {
                        ...
                        case "push_gantt":
                            ...
                            result = await (0, execute_1.executePushGantt)(uid, Object.assign({ uid }, args), { draftOnCreate: true });
                        ...
                        case "process_inbox_item":
                            ...
                            break;
                        case "propose_change":
                            result = await (0, execute_1.executeProposeChange)(uid, args);
                            actionLog.push(`📋 Proposition : ${(_m = args.title) !== null && _m !== void 0 ? _m : ""}`);
                            break;
                        // ── Programme du jour ──────────────────────────────────────────
