...
function steps(game) {
  return [
    ...
    { text: V + 'Tes gisements brillent dans la Bibliothèque, au nord. Monte les rejoindre…',
      done: () => game.CRYSTALS.some(c => Math.hypot(c.x - game.HERO.x, c.y - game.HERO.y) < 120) },

    { text: V + 'Ton bras droit aspire la masse lumineuse. Reste là jusqu\'à remplir ta jauge.',
      done: () => game.G.mass >= game.G.massCap - 1 },
