...
class _NextActionsSectionState extends State<NextActionsSection> {
  ...
  Future<void> _showCreateSheet() =>
      showCreateActionOrProjectSheet(context,
          logic: widget.logic,
          sync: widget.sync,
          onCreated: () {
            if (mounted) setState(() {});
...
/// Sheet « Créer » partagée (section Prochaines actions + onglet Actions) :
/// action simple (ownAction d'une activité, avec contexte GTD) ou nouveau
/// projet (flux déterministe).
