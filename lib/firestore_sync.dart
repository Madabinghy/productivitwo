...
class FirestoreSync {
  ...
  Future<void> deleteAccount() async {
    ...
    if (uid != null) {
      ...
      // Espace Coach : révocation best-effort du lien coach (fiche
      // server-only — coacheeApi journalise et coupe l'accès du coach).
      try {
        final idToken = await _auth.currentUser?.getIdToken();
        if (idToken != null) {
          await http.post(
            Uri.parse('https://coacheeapi-dzos75b65q-uc.a.run.app'),
            headers: {
